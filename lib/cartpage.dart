                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () => Provider.of<CoffeeShop>(context,
                                      listen: false)
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          // เมื่อคลิก จะทำการเคลียร์
                          Provider.of<CoffeeShop>(context, listen: false)
                              .clearCart();
                          // เมื่อคลิกที่ "Pay Now" ให้นำไปยังหน้าใหม่
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  PaymentPage(), // แทน PaymentPage() ด้วยหน้าที่คุณต้องการไป
                            ),
                          );
                        },
                        child: Container(
